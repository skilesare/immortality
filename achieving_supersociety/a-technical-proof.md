...
The things we will focus on in this section are the ideas of demurrage or the decay fee and the idea of the prefered stock that gets issued with each and every cash transaction in a hypercatallaxian economy.
...
For example, take two apples priced at $1.00 and $1.01. Apple 1 comes from a poorly run farm that abuses laborers and abuses its soil. Apple 2 comes from a well run farm that uses sustainable methods. Apple farm 1 will likely be out of business within the year, but the consumer doesn’t care. They buy apple 1 for its lower cost for the same commodity. Everyone would be better off if you bought apple 2, but you will not. You have no incentive too.

This presents a problem and now I have the model to prove we do not have to endure this problem. If we can fix this problem we can drastically increase our GDP.
...
Some nodes are better than other nodes at noticing the potential for cash transferred to another node(#2). IE, I’m better than you at investing in wine makers because I was one for 10 years and you just buy wine at the store.

Standard capitalism refreshes capital at nodes that succeed in #1, and nodes that use #2 to invest. Hypercatallaxy uses all economic activity when refreshing nodes in #2.

Theory: The more you refresh the nodes that are good at producing value and the nodes that excel at seeking value, you will have a more robust economy with much higher growth.
...
The pER is the rate at which that node produces Economic Rent on top of a sale. So if someone buys my good worth $1 and and my pER is 0.94, I will sell it for $1.94 (1 + pER) * amount. In this way the rich get richer. If you are good at producing economic rent you are going to make a lot of money. I do not judge whether the economic rent is good economic rent or bad economic rent, just that it is charged. I set these up in a natural distribution centered around n5.

The pReason value is the probability that a node will spend its money with a worthwhile node. This is a nodes ‘investment sense.’ Some of us are better than others at looking at who has made something and being able to make some predictions about their future earning potential. Some of us are Warren Buffet and some of us are Mr. Magoo. In this model I have reason as straight line increasing as we increment n. This is what we end up with:
...
We can see here a clear increase in GDP as we increase the decay fee. This is the result that I expected when I proposed the model. How can this be? When you remove cash from those that have it and give it to a random set you may not see this increase, but when you take it and give it to people that are good at spending it with value creators you increase GDP.
