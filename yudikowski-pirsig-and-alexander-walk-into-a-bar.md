...
I don't think Alexander gets it 100% correct and I think he is limited by his focus on architecture(but probably necessary to the formulation of the theory). It has much broader applications.
...
Eliezer wrote a series of blog posts over the course of number of years that has been combined into a book called [Rationality: From AI to Zombies](https://www.amazon.com/Rationality-AI-Zombies-Eliezer-Yudkowsky-ebook/dp/B00ULP6EW2/ref=as_li_ss_tl?s=books&ie=UTF8&qid=1484605484&sr=1-1&keywords=Rationality:+From+AI+to+Zombies&linkCode=ll1&tag=everybase-20&linkId=f183a3b09cd77970cf3380122295780a).These show how to think rationally and how to think like a scientist. He points out a number of things that I had not thought of before and approaches hard to understand topics with clear explanation.
...
He believes that ultimately the world consists of  just quarks but he's not against good maps, in fact, he's all about good maps which brings me to conclude, ultimately, that he and Dr. Pirsig are going to have more in common that you would think. I think this because at the end of the day, Yudkowsky has some raging humanist tendencies. One must reconcile ‘just quarks’ and humanism.
...
Robert Pirsig, best know for [Zen and the Art of Motorcycle Maintenance](http://amzn.to/2jsQc2T), puts forth a theory that there a driving force to our universe called Quality that originates and drives our perceptions of subjects and objects. He expands on this in a follow up book called [Lila](http://amzn.to/2jsSEGw) that has the meat of what I'd like to talk about. In Lila he goes deeper into creating a 'Metaphysics of Quality' and trades his Classic/Romantic split of ZMM for the Dynamic/Static distinction of Lila.
